...
class Triangle:public GeoShape{
    ...
    float calculateAreaT(){ // no input params as I already took them in the constructor
...
class Rectangle:public GeoShape{
    ...
    float calculateAreaR(){ // no input params as I already took them in the constructor
        float AreaR = d1 * d2;
        cout<<AreaR<<endl;
        return AreaR;
    }
...
class Circle:private GeoShape{ // private in CIRCLE, but I can access it from PARENT 3ady
    ...
    float calculateAreaC(){ // no input params as I already took them in the constructor
...
class Square: private Rectangle{
    ...
    float calculateAreaS(){
        /*float AreaS = d1 * d2;
        return AreaS;*/
        return Rectangle::calculateAreaR(); // I can return d1*d2 bas keda NO OVERRIDING
    }
